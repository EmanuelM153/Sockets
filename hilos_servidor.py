...
def handle_client(client_socket):
    # Se utiliza un bloque de try-except-finally ya que la comunicación en la red puede verse interrumpida
    try:
        ...
        # Si algún error ocurre en la comunicación, o sino es así, se cierra el descriptor del archivo del socket
        client_socket.close()
...
while True:
    ...
    # Se crea un hilo con la función `handle_client` y con argumento del nuevo objeto Socket
